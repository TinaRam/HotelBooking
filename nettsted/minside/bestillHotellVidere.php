...
function visDatepicker(hotellnavn, romtype, antallRom) {
	...
	foresporsel.onreadystatechange=function() {
		if (foresporsel.readyState==4 && foresporsel.status==200) {
			document.getElementById("Datepicker").innerHTML=foresporsel.responseText;
		}
	}
	foresporsel.open("GET","kalender.php?hotellnavn="+thisHotellnavn+"&romtype="+thisRomtype+"&antallRom="+thisantallRom);
	foresporsel.send();
}
...
function visDato(antallRom, romtype) {
  ...
  foresporsel.open("GET","phpVisPris.php?antallRom="+antallRom+"&hotellnavn="+thisHotellnavn+"&romtype="+romtype);
	foresporsel.send();*/
  visDatepicker(thisHotellnavn,thisRomtype,thisantallRom);
}
...
<form method="post" id="bestill" name="bestill">
  <div id="container">
    ...
    <div class="bokser" id="bokserDato">
      <h2>Dato</h2>
      Innsjekkingsdato<br>
    	<input type="text" id="innsjekking" name="innsjekking" placeholder="innsjekking" onFocus="visDatepicker()" autocomplete="off"><br><br>
      <div id="Datepicker" name="Datepicker" class="kalender" />
      Utsjekkingsdato<br>
    	<input type="text" id="utsjekking" name="utsjekking" placeholder="utsjekking" onFocus="visDatepicker()" autocomplete="off"><br>
    </div>
  </div>
