...
Hotell: <input type="text" id="sok" name="sok" /><br>
Romtype: <input type="text" id="romtype" name="romtype" /> <br>
Antallrom: <input type="text" id="antallRom" name="antallRom" /> <br>
